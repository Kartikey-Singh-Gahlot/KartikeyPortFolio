...
export const cvLink = "/KartikeyCV.pdf";
...
export const headerData = ["z-20 bg-gradient-to-r from-[#121d31] to-black sticky top-0 h-fit w-full flex justify-between items-center box-border py-5 px-10","z-20 bg-gradient-to-r from-black to-black fixed top-0 h-fit w-full flex flex-col box-border py-5 px-10 border-b-[1px] border-amber-50 "];
