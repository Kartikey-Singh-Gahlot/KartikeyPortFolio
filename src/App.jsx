    ...
    <div className="mainWrapper bg-gradient-to-r from-[#141E30] to-black ">
          ...
          <section>
               ...
               <div className="col-start-1 col-end-3 mt-10 md:grid flex flex-col grid-cols-2 grid-rows-[auto] mb-10 ">
                      <Experience experienceTitle="Business Development Associate | BANAO Technologies Benagaluru, Karnataka" experienceTimeline="June 2023 - October 2023" experienceDescription={[" Managed lead generation and business expansion strategies.", "Identified and engaged potential clients through outreach.", "Contributed in the scrapping extensions of the company."]}           experienceBoxStyle="hover:bg-black hover:border-amber-50 border-black border-[1px] box-border  col-span-1 px-8 text-[13px] my-5  md:text-right text-left   row-start-2 row-end-3 col-start-1 text-amber-50  "/>
                      <Experience experienceTitle="Junior Training Manager | BANAO Technologies Benagaluru, Karnataka"        experienceTimeline="Oct 2023 - Jan 2024" experienceDescription={["Assisted senior trainers in onboarding and training new hires", "Supervised a team of BDAs and promoted a positive team culture.", "Analyzed team progress and maintained performance records."]} experienceBoxStyle="hover:bg-black hover:border-amber-50 border-black border-[1px] box-border  col-span-1 px-8 text-[13px] my-5  md:text-left  text-left   row-start-3 row-end-4 col-start-2 text-amber-50 "/>
                </div>
           </section>
